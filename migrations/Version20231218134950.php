 ...
 */
final class Version20231218134950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, ticket_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, INDEX IDX_E01FBE6A700047D2 (ticket_id), INDEX IDX_E01FBE6AF8697D13 (comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
